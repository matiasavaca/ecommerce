class FindProducts
  attr_reader :products #crea un metodo que se llama products que devuelve @products
  ...
  def call(params = {})
    scoped = products
    scoped = filter_by_category_id(scoped, params[:category_id])#si el parametro category_id esta presente, filtra por ese parametro
